	...
	<section class="px-5 xl:px-0">
		<div class="max-w-[1170px] mx-auto">
			<div class="grid grid-cols-1 lg:grid-cols-2">
				<!-- Img box -->
				<div class="hidden lg:block bg-primaryColor rounded-l-lg">
					<figure class="rounded-l-lg">
						<img src="./assets/images/signup.gif" class="w-full rounded-l-lg" alt="">
					</figure>
				</div>

				<!-- Sign up form -->
				<div class="rounded-l-lg lg:pl-16 py-10">
					<h3 class="text-headingColor text-[22px] leading-9 font-bold mb-10">
						Create an <span class="text-primaryColor">account</span>
					</h3>

					<form action="registration.php" method="post">
						<div class="mb-5">
							<input type="text" placeholder="Full Name" name="user_name"
								class="w-full pr-4  py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor  cursor-pointer"
								required>
						</div>
						<div class="mb-5">
						...
						<div class="mb-5">
							<input type="password" placeholder="Password" name="user_pass" name="password"
								class="w-full pr-4  py-3 border-b border-solid border-[#0066ff61] focus:outline-none focus:border-b-primaryColor text-[16px] leading-7 text-headingColor placeholder:text-textColor  cursor-pointer"
								required>
						</div>

						<div class="mb-5 flex items-center justify-between ">
							<label class="text-headingColor font-bold text-[16px] leading-7"> Are you a:
								<select name="user_role" id="user_role" class="text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none">
									<option value="P">Patient</option>
									<option value="D" selected>Doctor</option>
								</select>
							</label>

							<label class="text-headingColor font-bold text-[16px] leading-7"> Gender:
								<select name="user_sex" class="text-textColor font-semibold text-[15px] leading-7 px-4 py-3 focus:outline-none">
						...
						<div class="mb-5 flex items-center gap-3">
							<figure class="w-[50px] h-[50px] rounded-full border-2  border-solid border-primaryColor flex items-center justify-center">
								<img src="./assets/images/doctor-img01.png" class="w-full rounded-full" alt="">
							</figure>

							<div class="relative w-[130px] h-[50px]">
								<input type="file" name="photo" id="customFile" accept=".jpg, .png"
									class="absolute top-0 left-0 w-full h-full opacity-0 cursor-pointer" name="user_pic">
							
								<label for="customFile"
									class="absolute top-0 left-0 w-full h-full flex items-center px-[0.75rem] py-[0.375rem] text-[15px] leading-6 overflow-hidden bg-[#0066ff46] text-headingColor font-semibold rounded-lg truncate cursor-pointer">Upload
									Photo</label>
							</div>
						</div>
						<div class="mt-7">
							<button type="submit"
								class="w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3">Sign Up</button>
						</div>
						
						<div class="mt-5 text-textColor text-center">
							Already have an account. <a href="login.php" class="text-primaryColor font-medium ml-1">Login</a>
						</div>
