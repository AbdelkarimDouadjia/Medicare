...
<body>
	...
	<section class="bg-[#fff9ea]">
		<div class="container text-center">
			<h2 class="heading">Find a Doctor</h2>
			<div class="max-w-[570px] mt-[30px] mx-auto bg-[#0066ff2c] rounded-md flex items-center  justify-between">

				<input type="search" class="py-4 pl-4 pr-2 bg-transparent w-full focus:outline-none curosr-pointer placeholder:text-textColor" placeholder="Search Doctor">
				<button class="btn mt-0 " style="margin-top: 0; border-radius: 0; border-top-right-radius: 0.375rem;border-bottom-right-radius: 0.375rem;">Search</button>
		...
		<div class="container">
			<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5  ">
				<div class="p-3 lg:p-5">
					...
					<h2 class="text-[18px] leading-[30px] lg:text-[26px] lg:leading-9 text-headingColor font-[700] mt-3 lg:mt-5">
						Dr. Alfaz Ahmed</h2>
					...
					<div class="mt-[18px] lg:my-5 flex items-center justify-betweenc">
						<div>
							<h3 class="text-[16px] leading-7 lg:text-[18px] lg:leading-[30px] font-semibold text-headingColor">
								+1500 patients</h3>
							...
							href="doctors.php"><svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16"
								class="group-hover:text-white w-6 h-5" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
