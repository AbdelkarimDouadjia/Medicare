...
<body>
	...
	<section>
		<div class="px-4 mx-auto max-w-screen-md ">
			...
			<p class="mb-8 lg:mb-16 font-light text-center text__para">
				Got a technical issua? Want to send feedback about a beta feature? Let us know.
			</p>
			<form action="#" class="space-y-8">
				<div>
					<label for="email" class="form__label">Your Email</label>
					<input type="email" id="email" placeholder="example@gmail.com" class="form__input mt-1">
				</div>
				<div>
					<label for="subject" class="form__label">Subject</label>
					<input type="text" id="subject" placeholder="Let us know we can help you" class="form__input mt-1">
				</div>
				<div class="sm:col-span-2">
					<label for="message" class="form__label">You Message</label>
					<textarea type="text" id="message" placeholder="Leave a comment ..." class="form__input mt-1" rows="6"></textarea>
				</div>
				<button type="submit" class="btn rounded-md sm:w-fit">Submit</button>
			</form>
		</div>
	</section>
	<!-- End Contact Section -->
